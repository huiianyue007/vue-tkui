<template>
  <div class="tkui-tab" :class="{'tkui-tab-no-animate': !animate}">
    <slot></slot>
    <div v-if="animate" class="tkui-tab-ink-bar" :class="barClass" :style="barStyle">
      <span class="tkui-tab-bar-inner" :style="innerBarStyle" v-if="customBarWidth"></span>
    </div>
  </div>
</template>
